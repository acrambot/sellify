...
<body>
	...
	<?php
			if(isset($_POST['phps_save'])) {
				$cur_fname = protect($_POST['cur_fname']);
				$cur_lname = protect($_POST['cur_lname']);
				$cur_email = protect($_POST['cur_email']);
				$cur_pname = protect($_POST['cur_pname']);
				$cur_facebook_url = protect($_POST['cur_facebook_url']);
				$cur_website_url = protect($_POST['cur_website_url']);
				$cur_twitter_name = protect($_POST['cur_twitter_name']);
				$cur_user_desc = protect($_POST['cur_user_desc']);
				$cur_avatar = protect($_POST['cur_avatar']);
				$cur_user_banner = protect($_POST['cur_user_banner']);
				$user_email = idinfo($_SESSION['ps_usern'],"email");
				$email_exists = mysql_query("SELECT * FROM sellify_users WHERE email='$_POST[cur_email]'");
				...
				elseif(!isValidEmail($cur_email)) { echo error('<p align="center">Please enter valid email address.</p>'); }
					...
					$update = mysql_query("UPDATE sellify_users SET fname='$cur_fname',lname='$cur_lname',email='$cur_email',pname='$cur_pname',facebook_url='$cur_facebook_url',website_url='$cur_website_url',twitter_name='$cur_twitter_name',user_desc='$cur_user_desc',avatar='$cur_avatar',user_banner='$cur_user_banner' WHERE usern='$_SESSION[ps_usern]'");
					$update = mysql_query("UPDATE sellify_items SET author_profile='$cur_pname', author_avatar='$cur_avatar' WHERE author='$_SESSION[ps_usern]'");
					$update = mysql_query("UPDATE sellify_purchases SET buyer_email='$cur_email' WHERE buyer_email='$user_email' AND usern='$_SESSION[ps_usern]'");
        ...
        <div class="ui grid form change-password">
            <div class="row">
                <div class="column field">
                    ...
                    <input id="pname" name="cur_pname" type="text" placeholder="Your public display name" value="<?php echo (idinfo($_SESSION['ps_usern'],"pname")); ?>" autocomplete="off" required>
                </div>
            </div>
			<div class="row">
                <div class="column field">
                    <label for="user_desc">Bio (Maximum 160 characters)</label>
                    <textarea id="user_desc" name="cur_user_desc" type="text" maxlength="160" placeholder="Interests, profesional knowledge, about you and your products etc." value="" autocomplete="off"><?php echo (idinfo($_SESSION['ps_usern'],"user_desc")); ?></textarea>
                </div>
            </div>
			<div class="row">
                <div class="column field">
                    ...
                    <div class="ui prepended input static twitter">
						...
						<input type="text" name="cur_twitter_name" placeholder="Your Twitter Username" id="twitter_name" autocomplete="off" value="<?php echo (idinfo($_SESSION['ps_usern'],"twitter_name")); ?>">
                    </div>
                </div>
            </div>
			<div class="row">
                <div class="column field">
                    ...
                    <input id="facebook_url" name="cur_facebook_url" type="url" placeholder="https://www.facebook.com/your.page" value="<?php echo (idinfo($_SESSION['ps_usern'],"facebook_url")); ?>" autocomplete="off">
                </div>
            </div>
			<div class="row">
                <div class="column field">
                    <label for="website_url">Website URL</label>
                    <input id="website_url" name="cur_website_url" type="url" placeholder="http://www.yoursite.com/" value="<?php echo (idinfo($_SESSION['ps_usern'],"website_url")); ?>" autocomplete="off">
                </div>
            </div>
			...
			<div class="row">
                <div class="column field">
                    ...
                    <input id="avatar" name="cur_avatar" type="url" placeholder="Full URL to a PNG, JPEG or JPG" value="<?php echo (idinfo($_SESSION['ps_usern'],"avatar")); ?>" autocomplete="off">
                </div>
            </div>
			...
			<div class="row">
                <div class="column field">
                    ...
                    <input id="user_banner" name="cur_user_banner" type="url" placeholder="Full URL to a PNG, JPEG or JPG" value="<?php echo (idinfo($_SESSION['ps_usern'],"user_banner")); ?>" autocomplete="off">
                </div>
            </div>
