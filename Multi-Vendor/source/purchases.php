			...
			<div class="row">
				<div class="column">
					<div id="purchases_list">						
						...
						$statement = "`sellify_purchases`";
						$sql = mysql_query("SELECT * FROM {$statement} WHERE usern='$_SESSION[ps_usern]' ORDER BY id DESC LIMIT {$startpoint} , {$limit}");
							...
							<div class="row">
							  <div class="six wide column">
								<div class="ui list product-meta">
								  <div class="item">
									<div class="content">
									  <div class="header">
										<a target="_blank" style="text-decoration:none!important;color:#e74c3c!important;" href="<?php echo $web['url']; ?>p/<?php echo $row['item_id']; ?>"><?php echo $row['name']; ?></a>
									  </div>
									  Redeem code: <?php echo $row['code']; ?>
									</div>
								  </div>
								</div>
							  </div>
							  <div class="six wide right aligned column">
								<div class="ui green buttons">
								  <a title="Download <?php echo $row['name']; ?>" class="ui button download-product" href="<?php echo $web['url']; ?>upgrade/redeem">
									Redeem
								  </a>
